    ...
    <section className="tweets">
      <article className="tweet">
        <header className="tweet--header">
          <img className="tweet--avatar" src="https://i.imgur.com/73hZDYK.png" alt="Newton's Avatar" /> {/* Add alt attribute to the image */}
      ...
      <article className="tweet">
        <header className="tweet--header">
          <img className="tweet--avatar" src="https://i.imgur.com/nlhLi3I.png" alt="Descartes's Avatar" /> {/* Add alt attribute to the image */}
